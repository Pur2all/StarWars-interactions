...
export default (app) => {
  ...
  */
  app.get('/character/:characterName', CharacterControl.filmsCharacterAppeared);
  ...
  /*
    ...
    */
  app.get('/character/:characters/:filmTitle', CharacterControl.charactersInteractionInFilm);
